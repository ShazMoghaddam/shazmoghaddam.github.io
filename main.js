...
(function(){
  ...
  for(i=0;i<n;i++){var t=i/(n-1),sh=0.30+0.55*Math.sin(Math.min(t,0.72)/0.72*Math.PI*0.9);
    if(t>0.72)sh=0.62-(t-0.72)*1.05;bars.push(Math.max(0.12,sh*0.86+(r()-0.5)*0.13));}
