...
(function() {
    const resources = {
        ...
        "es": {
            "translation": {
                ...
                "about_p2": "Fuera del trabajo con clientes y de producto, construyo mis propios proyectos: apps Android, herramientas para traders, sistemas de arte generativo, fondos de pantalla animados, salvapantallas, tipografías de nubes de palabras. Más de cincuenta proyectos hasta ahora, repartidos entre <strong>Google Play Store</strong>, <strong>Gumroad</strong>, <strong>Envato</strong> y <strong>Lemon Squeezy</strong>. Llevarlos yo mismo me ha enseñado cosas que un trabajo rara vez enseña: cómo poner precio a algo, cuándo lanzar en vez de seguir puliendo, y qué responde realmente la gente una vez que un producto está ahí fuera.",
    ...
    const htmlKeys = new Set(["hero_sub","about_heading","about_p2","about_p3","about_p4","certs_heading","built_heading","shipped_heading","written_heading","hub_medium"]);
